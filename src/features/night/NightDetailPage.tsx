...
import gmapsIcon from '../../assets/maps2.png'
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 text-gray-900 dark:text-white">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 flex flex-col gap-8">
        ...
        {/* Venue */}
        <Section title="Venue">
          <div className="rounded-xl bg-white dark:bg-zinc-900 ring-1 ring-gray-200 dark:ring-zinc-800 p-4 flex items-center justify-between gap-4">
            ...
            {night.venue.address && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 flex flex-col items-center gap-0.5 text-xs font-medium text-gray-500 dark:text-zinc-400 hover:text-gray-700 dark:hover:text-zinc-200 transition-colors"
              >
                <img src={gmapsIcon} alt="" className="w-8 h-8 object-contain" />
