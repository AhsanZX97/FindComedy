...
function NightGrid({ title, nights, emptyMessage }: {
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      {nights.length === 0 ? (
        <div className="rounded-2xl bg-white dark:bg-zinc-900 ring-1 ring-gray-200 dark:ring-zinc-800 p-8 text-center">
          <p className="text-gray-400 dark:text-zinc-500 text-sm">{emptyMessage}</p>
        </div>
      ) : (
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 text-gray-900 dark:text-white">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 flex flex-col gap-10">
        <div>
          <h1 className="text-2xl font-display font-bold text-gray-900 dark:text-white">My nights</h1>
          <p className="text-sm text-gray-500 dark:text-zinc-400 mt-1">Your saved and upcoming comedy nights.</p>
        </div>
